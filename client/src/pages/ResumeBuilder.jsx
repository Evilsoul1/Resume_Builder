...
const ResumeBuilder = () => {
  ...
  const changeResumeVisibility = async () => {
    try {
      ...
      console.log("Error visi saving resume : ",error);
    }
  }
          ...
          <div className='lg:col-span-7 max-lg:mt-6'>
            <div className='relative w-full'>
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                ...
                <button onClick={downloadResume} className='flex items-center py-2 px-6 gap-2 text-xs  bg-linear-to-br from-blue-100 to-blue-200 text-blue-600 rounded-lg ring-blue-300 hover:ring transition-colors'>
